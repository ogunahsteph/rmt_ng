...
def get_crb_history(client_bvn: str) -> pd.DataFrame:
...
def get_additional_crb_logic(client_bvn: str, scoring_summaries: pd.DataFrame) -> dict:
    import numpy as np
    raw_df = get_crb_history(client_bvn=client_bvn)
